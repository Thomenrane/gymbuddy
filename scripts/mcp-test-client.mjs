...
// Inventaire total : 14 (phase 4) + 5 (phase 6, plan) + 10 (lot 7) = 29.
check(`les 14 tools phase 4 exposés (total ${names.length})`, EXPECTED.every((t) => names.includes(t)) && names.length === 29);
